...
/**
 * <p>所有订单生成登记表</p>
 * <p>该数据表在一开始的时候就会生成订单，然后进行其他的操作</p>
 * @author K
 *
 */
public class OrderAllEntity extends BaseEntity<OrderAllEntity>{

    /**
	 * 
	 */
	private static final long serialVersionUID = -7926485523529928252L;
