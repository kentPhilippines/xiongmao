...
public class MyAccountContorller {
	...
	public String userDealShow(Model m) {
		...
		*/
		...
		HighcharBenaSuper<List<HighcharBena>> statisticsToAmount = new HighcharBenaSuper<List<HighcharBena>>();
		HighcharBenaSuper<List<HighcharBena>> statisticsToCount = new HighcharBenaSuper<List<HighcharBena>>();
		...
		List<HighcharBena>  accountAmountDate = new ArrayList<HighcharBena> ();
		List<HighcharBena>  accountCountDate = new ArrayList<HighcharBena> ();
		if(CollUtil.isNotEmpty(dealShow3)) {
			statisticsToAmount = statisticsUtil.statisticsToAmount(dealShow3, accountList);
			statisticsToCount = statisticsUtil.statisticsToCount(dealShow3, accountList);
