		...
		<div class="layui-card"  style="padding: 15px;">
			...
			<div class="layui-card-body">
				<div style="padding-bottom: 10px;">
					<button class="layui-btn layuiadmin-btn-admin" data-type="add" addUrl = "${ctx}/manage/agent/userManageAdd">添加</button>
				</div>
				<table id="LAY-user-back-manage" url = "${ctx}/manage/agent/appAccountManageList" lay-filter="LAY-user-back-manage"></table>
			</div>
		</div>
	</div>
	<script type="text/html" id="operation">
 	 <a class="layui-btn layui-btn-xs" lay-event="edit" url = "${ctx}/manage/agent/appAccountEditShow">编辑</a>
