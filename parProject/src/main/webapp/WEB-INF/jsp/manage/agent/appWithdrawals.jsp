...
<body layadmin-themealias="default" style=" background-color: #ffffff00;" >
	...
	<div class="layui-form-item">
	   ...
	   <div class="layui-inline">
	    ...
	    <div class="layui-input-inline">
	     <input type="text" name="retain3" autocomplete="off" class="layui-input" value = "${user.retain3}" >
	    </div>
	  </div>
	   <div class="layui-inline">
	    <label class="layui-form-label">到账银行卡</label>
	    <div class="layui-input-inline">
	     <input type="text" name="backCard" autocomplete="off" class="layui-input"  >
	    </div>
	  </div>
	    <div class="layui-inline">
	  ...
	  <div class="layui-layer-btn layui-layer-btn-">
			<a class="layui-layer-btn0" url = "${ctx}/manage/agent/amount">确定</a>
		</div>
	</form>
</body>
</html>
