		...
		<div class="layui-card"  style="padding: 15px;">
			...
			<div class="layui-card-body">
				<div style="padding-bottom: 10px;">
					<button class="layui-btn layuiadmin-btn-admin" data-type="add" addUrl = "${ctx}/manage/channel/channelAdd">添加渠道</button>
				</div>
				<table id="LAY-user-back-manage" url = "${ctx}/manage/channel/channelList" lay-filter="LAY-user-back-manage"></table>
			</div>
		</div>
	</div>
	<script type="text/html" id="operation">
 	 <a class="layui-btn layui-btn-xs" lay-event="edit" url = "${ctx}/manage/channel/channelEditShow">编辑</a>
 	 <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del" url = "${ctx}/manage/channel/channelDel">删除</a>
	</script>
</body>
</html>
